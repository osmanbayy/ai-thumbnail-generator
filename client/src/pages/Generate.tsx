            ...
            <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  {/* Style Selector */}
                  <StyleSelector isOpen={styleDropdownOpen} setIsOpen={setStyleDropdownOpen} onChange={setStyle} value={style} />
                  ...
                  <div className="space-y-2">
                    <label htmlFor="details" className="block text-sm font-medium">Additional Prompts <span className="text-zinc-400">(optional)</span></label>
                    <textarea
                      name="details"
