  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <button onClick={() => setIsOpen(false)} className="absolute top-5 right-5 active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center transition text-white rounded-md flex">
          <XIcon />
        </button>
      </div>
    </>
